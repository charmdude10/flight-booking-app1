    ...
    <>
      ...
      <div className="flex ">
        ...
        <div className="w-1/4 p-4 m-8 rounded-2xl bg-gray-100 transition-all duration-300 ease-in-out ">
          ...
          {/* best flight */}
          <span className="text-gray-500 text-sm italic flex justify-center">
            Cheapest Flight
          </span>
          <div className="flex flex-row place-items-center justify-between gap-3 p-2">
            <div className="flex items-center gap-2">
              <img
                alt="Airline Logo"
                className="w-10 h-10"
                src="https://logos.skyscnr.com/images/airlines/favicon/ET.png"
              />
            ...
            <button className=" hover:shadow-md text-green-500 bg-gray-300 font-bold py-2 px-4 rounded underline italic">
              Book
            </button>
          </div>
