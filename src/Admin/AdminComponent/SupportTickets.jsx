...
const SupportTickets = () => {
  ...
  const [tickets, setTickets] = useState([
    {
      ...
      description:
        "I am trying to cancel my booking but the system shows an error message.",
      priority: "High",
      status: "Open",
    ...
    },
    {
      ...
      description:
        "My payment was deducted but I did not receive booking confirmation.",
      priority: "Urgent",
      status: "In Progress",
      category: "Payment",
  ...
  const assignTicket = (ticketId, agent) => {
    setTickets(
      tickets.map((ticket) =>
        ticket.id === ticketId
          ? { ...ticket, assignedTo: agent, status: "In Progress" }
          : ticket
      )
    );
                              ...
                              <div className="grid grid-cols-2 gap-4">
                                ...
                                <div>
                                  ...
                                  <Dropdown
                                    ...
                                    onValueChange={(value) =>
                                      assignTicket(selectedTicket.id, value)
                                    }
                                  >
                                    <DropdownItem>Agent Smith</DropdownItem>
                                    <DropdownItem>Agent Johnson</DropdownItem>
                                    <DropdownItem>Agent Williams</DropdownItem>
                                  </Dropdown>
                                </div>
                              </div>
                            </div>
