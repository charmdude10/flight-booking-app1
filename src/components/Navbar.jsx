...
function CustomNavbar() {
  ...
  const { isAuthenticated, logout, setDepartureCity, setDestinationCity } =
    ...
    <>
      <Navbar fluid className=" px-44  bg-white h-35 ">
        ...
        <Navbar.Collapse>
          ...
          <Navbar.Link className="text-black">Services</Navbar.Link>
          <Navbar.Link className="text-black">Pricing</Navbar.Link>

          <Link to="/contact">
            <Navbar.Link className="text-black">Contact</Navbar.Link>
          </Link>
        </Navbar.Collapse>
      </Navbar>
    </>
